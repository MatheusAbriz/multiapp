...
* **⚖️ Calculadora de IMC:** Recebe peso e altura, processa o cálculo matemático e envia os dados para uma segunda tela que exibe a classificação do Índice de Massa Corporal.
* **✂️ Jokenpo (Pedra, Papel e Tesoura):** Clássico jogo "Melhor de 3" contra o computador (PC), com persistência de placar durante as rodadas e opção de reiniciar a partida.
